    ...
    public class AzureTranslationService : ITranslationService
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var content = new TranslateContent(text);
            ...
            CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                var translationOptions = new TranslateOptions(options.TargetLanguage)
                {
                    FromLanguage = options.SourceLanguage
                };
                
                var response = await client.TranslateAsync("Hello", translationOptions, cancellationToken);
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var languages = response.Value.Translation;
        ...
        private TextTranslationClient CreateTranslatorClient(TranslationOptions options)
        {
            ...
            clientOptions.Default.RequestHeaders.Add("Ocp-Apim-Subscription-Region", options.Region);
